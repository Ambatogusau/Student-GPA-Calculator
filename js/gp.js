...
function calculateGradePoint(totalMarks) {
    if (totalMarks >= 75) return 4.0; // 
    if (totalMarks >= 74) return 3.5; // 
    if (totalMarks >= 70) return 3.25; // 
    if (totalMarks >= 65) return 3.0; // 
    if (totalMarks >= 60) return 2.75; // 
    if (totalMarks >= 55) return 2.5; // 
    if (totalMarks >= 50) return 2.25; // 
    if (totalMarks >= 45) return 2.0; // 
